...
_Prefixes may vary slightly across different snippet extensions. The most popular extension is **ES7 React/Redux/GraphQL/React-Native snippets** (by dsznajder / rodrigovallades)._
